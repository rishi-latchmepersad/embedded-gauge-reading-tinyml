"""Package the YOLO11n-OBB model for STM32N6 relocatable deployment."""
...
MODEL_NAME: str = "yolo_obb_320"
PACKAGE_DIRNAME: str = "yolo_obb_320"
TFLITE_MODEL: Path = (
	REPO_ROOT
	/ "ml"
	/ "artifacts"
...
STAGING_BUILD: Path = REPO_ROOT / "tmp" / "stedgeai_yolo_obb_320_build"
TEMP_WORKSPACE: Path = REPO_ROOT / "tmp" / "stedgeai_yolo_obb_320_ws"
TEMP_OUTPUT: Path = REPO_ROOT / "tmp" / "stedgeai_yolo_obb_320_out"
