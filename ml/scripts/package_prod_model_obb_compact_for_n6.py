"""Package the compact full-frame OBB model for STM32N6 relocatable deployment."""
...
MODEL_NAME: str = "prod_model_obb_compact_int8"
PACKAGE_DIRNAME: str = "prod_model_obb_compact_int8"
TFLITE_MODEL: Path = (
	REPO_ROOT
	/ "ml"
	/ "artifacts"
...
STAGING_BUILD: Path = REPO_ROOT / "tmp" / "stedgeai_prod_model_obb_compact_build"
TEMP_WORKSPACE: Path = REPO_ROOT / "tmp" / "stedgeai_prod_model_obb_compact_ws"
TEMP_OUTPUT: Path = REPO_ROOT / "tmp" / "stedgeai_prod_model_obb_compact_out"
