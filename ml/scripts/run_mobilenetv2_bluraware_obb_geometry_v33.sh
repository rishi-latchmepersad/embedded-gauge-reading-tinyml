...
# Train a blur-aware OBB-geometry MobileNetV2 variant using raw-plus-sharpened
# views so we can test whether low-contrast / preview-style hard cases improve.

REPO_ROOT="/mnt/d/Projects/embedded-gauge-reading-tinyml/ml"
POETRY_BIN="${POETRY_BIN:-${HOME}/.local/bin/poetry}"
LOG_DIR="${REPO_ROOT}/artifacts/training_logs"
LOG_FILE="${LOG_DIR}/mobilenetv2_bluraware_obb_geometry_v33.log"
RUN_NAME="${RUN_NAME:-mobilenetv2_bluraware_obb_geometry_v33}"
