...
#
# This uses the model's own gauge_value output as the final prediction so we can
# see whether the blur-aware branch is already strong enough to stand alone
# before we decide whether a second-stage reader is still necessary.

REPO_ROOT="/mnt/d/Projects/embedded-gauge-reading-tinyml/ml"
POETRY_BIN="${POETRY_BIN:-${HOME}/.local/bin/poetry}"
LOG_DIR="${REPO_ROOT}/artifacts/training_logs"
LOG_FILE="${LOG_DIR}/mobilenetv2_bluraware_obb_geometry_self_cascade_v33.log"
OUTPUT_DIR="${REPO_ROOT}/artifacts/cascade_eval/mobilenetv2_bluraware_obb_geometry_self_v33"

LOCALIZER_MODEL="${LOCALIZER_MODEL:-${REPO_ROOT}/artifacts/training/mobilenetv2_bluraware_obb_geometry_v33/model.keras}"
