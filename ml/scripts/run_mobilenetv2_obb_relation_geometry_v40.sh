...
# Relation-aware geometry fine-tune for the OBB-mask reader.
# This version keeps the OBB localizer and four geometry landmarks, then
# learns the pointer-to-scale relation directly from those landmarks.
cd "$(dirname "$0")/.."

mkdir -p artifacts/training_logs

LOG_FILE="artifacts/training_logs/mobilenetv2_obb_relation_geometry_v40.log"

echo "[RUN] Starting MobileNetV2 OBB-relation-geometry v40 training."
