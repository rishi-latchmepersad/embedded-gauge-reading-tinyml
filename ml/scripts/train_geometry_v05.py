#!/usr/bin/env python3
"""Train MobileNetV2 geometry model with board-style augmentation, evaluated on hard cases."""
...
def main():
    config = TrainConfig(
        model_family='mobilenet_v2_geometry',
        epochs=40,
        learning_rate=1e-4,
        batch_size=8,
        seed=21,
    ...
    run_dir = Path('artifacts/training/mobilenetv2_geometry_board_augment')
