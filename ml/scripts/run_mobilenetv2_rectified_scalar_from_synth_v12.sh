...
# Fine-tune the strict rectified scalar model from a synthetic pretrain.
#
# The synthetic model should already know how to read gauge-like angles. This
# stage lets it adapt that knowledge to the real strict rectified images.

ROOT_DIR="$(cd "$(dirname "${BASH_SOURCE[0]}")/.." && pwd)"
LOG_DIR="${ROOT_DIR}/artifacts/training_logs"
LOG_FILE="${LOG_DIR}/mobilenetv2_rectified_scalar_from_synth_v12.log"
...
INIT_MODEL="artifacts/training/mobilenetv2_synthetic_pretrain_v11/model.keras"
OUTPUT_DIR="artifacts/training/mobilenetv2_rectified_scalar_from_synth_v12"

echo "[WRAPPER] Starting rectified fine-tune from synthetic pretrain v12." | tee "${LOG_FILE}"
...
echo "[WRAPPER] Rebuilding strict rectified training manifest..." | tee -a "${LOG_FILE}"
