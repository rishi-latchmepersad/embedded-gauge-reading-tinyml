...
# Fit a piecewise-linear calibration layer on top of the best scalar model.
# The model and manifest are staged into WSL-local storage to keep the fit
...
OUTPUT_DIR="${OUTPUT_DIR:-artifacts/training/scalar_full_finetune_from_best_piecewise_calibrated}"
LOG_DIR="${REPO_ROOT}/artifacts/training_logs"
LOG_FILE="${LOG_DIR}/scalar_full_finetune_from_best_piecewise_calibration.log"
WORK_ROOT="${WORK_ROOT:-${HOME}/calibration_scalar_full_piecewise}"
