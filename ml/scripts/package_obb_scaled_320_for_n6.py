"""Package the scaled OBB full-frame model for STM32N6 (no HyperRAM)."""
...
MODEL_NAME: str = "obb_scaled_320_int8"
PACKAGE_DIRNAME: str = "obb_scaled_320_int8"
TFLITE_MODEL: Path = (
    REPO_ROOT
    / "ml"
    / "artifacts"
    / "training"
    / "obb_scaled_320_20260610_101410"
    / "obb_scaled_cubeai_int8.tflite"
)
...
STAGING_BUILD: Path = REPO_ROOT / "tmp" / "stedgeai_obb_scaled_320_build"
TEMP_WORKSPACE: Path = REPO_ROOT / "tmp" / "stedgeai_obb_scaled_320_ws"
TEMP_OUTPUT: Path = REPO_ROOT / "tmp" / "stedgeai_obb_scaled_320_out"
