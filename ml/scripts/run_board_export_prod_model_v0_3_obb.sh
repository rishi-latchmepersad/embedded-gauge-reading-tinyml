...
LOG_FILE="${LOG_DIR}/prod_model_v0_3_obb_board_export.log"
MODEL_IN="${MODEL_IN:-artifacts/training/mobilenetv2_obb_longterm/model.keras}"
MANIFEST_IN="${MANIFEST_IN:-data/hard_cases_plus_board30_valid_with_new5.csv}"
OUTPUT_DIR="${OUTPUT_DIR:-artifacts/deployment/prod_model_v0.3_obb_int8}"
WORK_ROOT="${WORK_ROOT:-${HOME}/prod_model_v0_3_obb_board_export}"
...
echo "[WRAPPER] Staging prod-v0.3 OBB model into ${WORK_ROOT}."
cp "${REPO_ROOT}/${MODEL_IN}" "${BASE_MODEL_LOCAL}"

cd "${REPO_ROOT}"

echo "[WRAPPER] Starting board export for prod_model_v0.3_obb_int8."
