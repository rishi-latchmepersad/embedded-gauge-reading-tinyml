...
def test_resolve_repo_path_uses_repo_root_for_relative_paths() -> None:
    ...
    repo_root = Path("/repo")
    resolved = _resolve_repo_path(Path("ml/data/captured_images/capture_0c_preview.png"), repo_root)
    assert resolved == Path("/repo/ml/data/captured_images/capture_0c_preview.png")
