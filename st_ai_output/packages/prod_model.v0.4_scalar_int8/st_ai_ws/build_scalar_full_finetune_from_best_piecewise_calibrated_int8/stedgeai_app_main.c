...
LL_ATON_DECLARE_NAMED_NN_INSTANCE_AND_INTERFACE(scalar_full_finetune_from_best_piecewise_calibrated_int8) // Defines NN_Instance_scalar_full_finetune_from_best_piecewise_calibrated_int8 and NN_Interface_scalar_full_finetune_from_best_piecewise_calibrated_int8 with network.c info
...
AI_ALIGNED(32)
static ai_u8 activations_4[155648];
AI_ALIGNED(32)
...
AI_ALIGNED(32)
static ai_u8 weights_9[3218833];
...
int main(int argc, char* argv[])
{
  ...
  while(1)
  {
    LL_ATON_RT_Main(&NN_Instance_scalar_full_finetune_from_best_piecewise_calibrated_int8);
  }
}
