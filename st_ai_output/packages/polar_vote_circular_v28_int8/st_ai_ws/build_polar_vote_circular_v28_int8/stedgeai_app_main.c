...
LL_ATON_DECLARE_NAMED_NN_INSTANCE_AND_INTERFACE(polar_vote_circular_v28_int8) // Defines NN_Instance_polar_vote_circular_v28_int8 and NN_Interface_polar_vote_circular_v28_int8 with network.c info

AI_ALIGNED(32)
static ai_u8 activations_1[0];
AI_ALIGNED(32)
static ai_u8 activations_2[401408];
AI_ALIGNED(32)
static ai_u8 activations_3[401408];
AI_ALIGNED(32)
...
int main(int argc, char* argv[])
{
  ...
  while(1)
  {
    LL_ATON_RT_Main(&NN_Instance_polar_vote_circular_v28_int8);
  }
}
