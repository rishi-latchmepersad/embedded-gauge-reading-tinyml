/**
 * @file    app_ai_inference.c
 * @brief   Inference module compilation unit.
 *
 * Pulls in the model-management and decode helper implementations that
 * were previously only available inside the monolithic app_ai.c
 * translation unit.
 */
...
#include "app_ai_helpers_model.inc"
#include "app_ai_helpers_decode.inc"

void AppAI_LogScalarInternalOutputProbe(
