...
void HAL_DCMIPP_MspInit(DCMIPP_HandleTypeDef* hdcmipp)
{
  if(hdcmipp->Instance==DCMIPP)
  {
    ...
    /* The application re-applies the final CSI/DCMIPP kernel clocks after
     * MX_DCMIPP_Init(). Keep only IRQ setup here so CubeMX regeneration does
     * not clobber the working camera clock override. */
