/**
 * @file    app_ai_preprocess.c
 * @brief   Preprocess module compilation unit.
 *
 * Pulls in the runtime helper implementations that were previously only
 * available inside the monolithic app_ai.c translation unit.
 */
...
#include "app_ai_helpers_runtime.inc"
