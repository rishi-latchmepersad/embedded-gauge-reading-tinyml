...
float app_ai_last_pivot_source_x = 0.0f;
float app_ai_last_pivot_source_y = 0.0f;
bool app_ai_last_pivot_source_valid = false;
...
/* Board bbox OBB pool.
 * Weight blob: obb_box_board_bbox_deploy_candidate_atonbuf.xSPI2.raw
 * Flashed to 0x71400000 (679,841 bytes, 664 KB).
 * No HyperRAM needed. */
...
/* Live board-bbox OBB pool symbol used by the current qarepvgg wrapper. */
__attribute__((section(".xspi2_obb_pool"), aligned(APP_AI_CACHE_LINE_BYTES)))
uint8_t _mem_pool_xSPI2_obb_box_board_bbox_deploy_candidate[32U] = { 0U, };

/* Tip-focus v18 model pool.
 * Weight blob: tip_focus_v18_int8_atonbuf.xSPI2.raw
 * Flashed to 0x70400000 (834,465 bytes, 815 KB).
 * No HyperRAM needed — the no-HyperRAM mpool kept all activations on-chip.
 *
...
/* Board-bbox OBB xSPI2 signatures.
 * Flashed to 0x71400000. Size: 679,841 bytes (664 KB).
 * SHA256[:16]: 5BC95D0DB30862BE */
...
/* Tip-focus v18 xSPI2 signatures.
 * Flashed to 0x70400000. Size: 834,465 bytes (815 KB).
 * SHA256[:16]: 3588104D20D96224 */
