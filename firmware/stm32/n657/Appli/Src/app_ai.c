...
/* Compact OBB 320 localizer pool lives in the dedicated OBB flash slot (0x71400000). so the linker script can map it to
...
/* Board bbox OBB pool lives in the dedicated OBB flash slot (0x71400000).
