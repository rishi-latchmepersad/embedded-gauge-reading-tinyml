/**
 * @file    app_ai_xspi2.c
 * @brief   Compilation unit that exports the xSPI2 / NPU / cache helpers.
 *
 * This is a thin wrapper that includes the core .inc file so the
 * function bodies live in their own translation unit.  Other .c files
 * include app_ai_xspi2.h and link against this TU at build time.
 */
...
#include "app_ai_helpers_core.inc"
