/**
 * @file    app_ai_stage_obb.c
 * @brief   OBB localizer stage module.
 *
 * This compilation unit includes the QARepVGG-Pro decode
 * implementations and exposes the OBB public surface via
 * app_ai_stage_obb.h.
 */
