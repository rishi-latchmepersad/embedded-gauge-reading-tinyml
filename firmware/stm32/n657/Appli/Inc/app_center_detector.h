 ...
 *
 * Pipeline:
 *   1. Crop the full-frame YUV422 to an OBB-localized gauge patch.
 ...
 * @param crop_x_min       Left edge of the OBB crop (pixels, full-frame coords).
 * @param crop_y_min       Top edge of the OBB crop.
 * @param crop_width       Width of the OBB crop (pixels).
 * @param crop_height      Height of the OBB crop.
